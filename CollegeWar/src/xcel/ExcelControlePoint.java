 ...
 */
public class ExcelControlePoint {

	private static ArrayList<String[]> tab = new ArrayList<String[]>();
	private static int line = 0;
	private static int column = 0;

	private final static String SAMPLE_XLSX_FILE_PATH = "./CardsControlePoint.xls";
	private final static int NB_COLUMNS = 15;
	private final static int NB_LINES = 5;
